...
function Contenttabelpesanandipesandibatalkan() {
  return (
    <div>
         <Card>
          <Card.Body>
            ...
            <div className="d-flex justify-content-between">
              <p>No Pesanan :</p>
              <p className="fw-bold">AR-F/ORD-20230815-0001</p>
            </div>
            <div className="d-flex justify-content-between">
              <p>No Transaksi :</p>
              <p className="fw-bold">AR-F/TRX-20230815-0001</p>
            </div>
            <div className="d-flex justify-content-between">
              <p>Waktu Pemesanan :</p>
...
export default Contenttabelpesanandipesandibatalkan