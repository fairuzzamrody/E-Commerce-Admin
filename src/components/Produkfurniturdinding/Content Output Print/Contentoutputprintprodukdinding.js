...
import { Container, Table, Image, Button, Card } from "react-bootstrap";

function Contentoutputprintprodukdinding() {
	  ...
	  <Container fluid>
		...
		<Container>
		  <Container>
			...
			<p style={{ marginTop : "-10px" }}><b>Sumber Data</b> : Produk Dinding</p>
...
export default Contentoutputprintprodukdinding