...
import ContentdetailtrasaksisudahbayardiskonPC from "./Componen Detail transaksi sudah bayar/ContentdetailtrasaksisudahbayardiskonPC";

function Contentdetailtransaksisudahbayardiskon() {
  return (
    <div>
         <div>
  ...
  <p className="text-muted">Jl. Mangga BesarSikep, Keboansikep, Kec. Gedangan, Kabupaten Sidoarjo, Jawa Timur 61254</p>
        ...
        <h5 className="card-title" style={{ marginTop: "-25px" }}>Detail Produk yang Dipesan</h5>
          ...
          <div className="d-none d-md-block">
                <ContentdetailtrasaksisudahbayardiskonPC />
                 </div>
...
export default Contentdetailtransaksisudahbayardiskon