...
function ContentdetailtransaksikadeluarsadiskonPC() {
  return (
    <div>
      <Card>
        <Card.Body>
          ...
          <Table striped bordered hover>
            ...
            <tbody>
              <tr>
                ...
                <td className="text-center">
                  <span className="badge badge-danger">Kadeluarsa</span>
                </td>
              </tr>
            </tbody>
          </Table>
...
export default ContentdetailtransaksikadeluarsadiskonPC;
