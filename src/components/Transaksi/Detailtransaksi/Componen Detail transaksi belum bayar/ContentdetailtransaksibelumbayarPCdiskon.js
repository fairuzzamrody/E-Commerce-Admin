...
function ContentdetailtransaksibelumbayarPCdiskon() {
  return (
    <div>
      <Card>
        <Card.Body>
          ...
          <Table striped bordered hover>
            ...
            <tbody>
              <tr>
                ...
                <td className='text-center'>Rp 1.500.000 <br/>
                <span class="badge rounded-pill text-bg-warning">Flash Sale 1.1 <i class="bi bi-lightning-fill"></i></span>

                </td>
                <td className='text-center'>
                  <span className="badge badge-primary">Menunggu <br/>Pembayaran</span>
                </td>
              </tr>
            </tbody>
          </Table>
    ...
    <div className="d-flex justify-content-between">  
    <p>Harga Flash sale : <span class="badge rounded-pill text-bg-warning">-25%</span>
</p>
    <p>Rp 750.000</p>
    </div>
          <div className="d-flex justify-content-between">  
...
export default ContentdetailtransaksibelumbayarPCdiskon