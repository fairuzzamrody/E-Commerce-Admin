...
function ContentInformasiProdukDindingMobile() {
	...
	const handlePakaiOngkirChange = (e) => {
		...
		if (value === "tidak") {
			...
			setOngkosKirimPlaceholder("Free Ongkir");
		} else {
    ...
    <div>
      <Form>
        <Form.Group controlId="namaProduk" className="mb-3">
          ...
          <Form.Group controlId="subNamaproduk" className="mb-2">
          ...
          <Form.Group controlId="stokkategori" className="mb-2">
		...
		{/* Disable harga produk ketika user mengAKtifkan Varian Produk */}
          <Form.Group controlId="hargaProduk" className="mb-2">
            ...
            <InputGroup>
              ...
              <div className="input-group-append">
                <InputGroup.Text onClick={toggleInputGroup}>
                  {isInputGroupOpen ? <FaChevronUp /> : <FaChevronDown />}
                </InputGroup.Text>
              </div>
            </InputGroup>
          </Form.Group>
...
export default ContentInformasiProdukDindingMobile