...
import Contenttabelprodukdataranaktif from "../Produkfurniturdataran/Tabel Furnitur/Contenttabelprodukdataranaktif";
import Contenttabelprodukdataransegerahabis from "./Tabel Furnitur/Contenttabelprodukdataransegerahabis";
import Contenttabelprodukdatarannonaktif from "./Tabel Furnitur/Contenttabelprodukdatarannonaktif";

function Contentprodukfurniturdataran() {
	return (
		<div>
			{/* Nama Halaman */}
				...
				<Card className="mt-4">
					<Card.Body>
						...
						<div className="d-none d-md-block">
							<Contenttabelprodukdataranaktif />
							<Contenttabelprodukdataransegerahabis />
							<Contenttabelprodukdatarannonaktif />
						</div>
					</Card.Body>
				</Card>
			</section>
...
export default Contentprodukfurniturdataran;
