...
const Dataprodukdinding = [
  ...
  {
    id: 2,
    nama: "Meja Dinding Eropa",
    varian: "Putih, Hijau",
    hargaAwal: "Rp. 2.850.000",
    stokYangDipilih: "10 Produk",
    persentaseDiskon: "30%",
...
function Contenttabelprodukflashsalediskonkeseluruhandindingmobile() {
  return (
    <div>
...
export default Contenttabelprodukflashsalediskonkeseluruhandindingmobile