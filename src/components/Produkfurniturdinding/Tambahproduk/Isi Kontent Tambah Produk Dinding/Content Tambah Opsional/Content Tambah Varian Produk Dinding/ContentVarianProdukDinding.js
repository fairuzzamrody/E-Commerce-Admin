...
function ContentVarianProdukDinding() {
  ...
  return (
    <Card>
      ...
      <Card.Title>Varian Produk</Card.Title>
        <p>Isi masing-masing kotak dengan "Red", "Green" tanpa menggunakan tanda (" "). </p>
				<p>
					Warna harus disebutkan dalam Bahasa Inggris atau sebagai kode warna
					CSS (Maksimal 5 Warna) agar Augmented Reality dapat membaca warna tersebut. Nantinya, warna-warna ini akan diubah menjadi
					Bahasa Indonesia saat ditampilkan di halaman detail produk. Stoknya
...
export default ContentVarianProdukDinding