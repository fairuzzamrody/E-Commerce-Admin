...
const DataprodukDataran = [
  {
    ...
    varian: "Semua Varian",
    detailVarian : "Hijau, Kuning, Merah",
...
function Contenttabelprodukflashsalediskonmanualdataranmobile() {
...
export default Contenttabelprodukflashsalediskonmanualdataranmobile;
