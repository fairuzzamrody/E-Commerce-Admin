...
import ContentdetailtransaksidibatalkanPC from "./Componen Detail transaksi dibatalkan/ContentdetailtransaksidibatalkanPC";

function Contentdetailtransaksidibatalkan() {
  return (
    <div>
...
<ContentdetailtransaksidibatalkanPC />
       </div>
    </section>
  </div>
  )
...
export default Contentdetailtransaksidibatalkan