...
function Contentlaporanpendapatan() {
		...
		<div>
			<Card>
				<Card.Body>
					...
					<p>
						Pendapatan yang berhasil diraih pada tanggal 29 Agustus 2023 hingga
						30 Agustus 2023 mencapai angka luar biasa sebesar{" "}
...
export default Contentlaporanpendapatan;
