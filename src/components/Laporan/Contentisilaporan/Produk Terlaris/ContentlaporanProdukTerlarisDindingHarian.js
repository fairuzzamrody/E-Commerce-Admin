...
function ContentlaporanProdukTerlarisDindingHarian() {
  ...
  return (
    <div>
      <Card className="top-selling overflow-auto">
        <Card.Body>
          <h5 className="card-title">Produk Dinding Terlaris (terjual lebih dari 5)</h5>
...
export default ContentlaporanProdukTerlarisDindingHarian