...
import ContentDiskonProdukuntukVarianDinding from "./ContentDiskonProdukuntukVarianDinding";

function ContentDiskonProdukDinding() {
	...
	return (
		<div>
			<Card>
				<Card.Body>
					<Card.Title>Masukkan Persentase Diskon</Card.Title>
					{formVisible && (
						<Form>
							<Form.Label>Diskon Keseluruhan</Form.Label>
					...
					<div className="d-flex justify-content-between">
						<p>Aktifkan diskon per varian ?</p>
					...
					{showContent && <ContentDiskonProdukuntukVarianDinding />}
...
export default ContentDiskonProdukDinding;
