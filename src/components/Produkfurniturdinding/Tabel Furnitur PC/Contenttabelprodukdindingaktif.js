...
function Contenttabelprodukdindingaktif() {
  ...
  const [products, setProducts] = useState([
		{
			...
			currentStock: 8,
			sold: "2X",
			image: "assets/assets/img/product-4.jpg", // URL gambar unik
		},
		// Tambahkan data produk lainnya sesuai kebutuhan
		{
			...
			currentStock: 12,
			sold: "3X",
			image: "assets/assets/img/product-3.jpg", // URL gambar unik
		},
	...
	const [newStock, setNewStock] = useState(""); // State untuk menyimpan input stok baru
...
export default Contenttabelprodukdindingaktif;
