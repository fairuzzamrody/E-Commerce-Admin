...
function Contenttabelprodukdatarannonaktif() {
			...
			<Card className="top-selling overflow-auto">
				<div className="card-body pb-0">
					...
					<div className="d-flex justify-content-between d-block d-md-none">
						...
						<Card.Title>
							<span className="d-block d-md-none" style={{ fontSize: "0.8rem" }}>
								{" "}
											...
											{product.status === "Diarsipkan" ? (
												<>
													...
													>
														...
														<Dropdown.Menu>
															<Dropdown.Item onClick={handleDeleteClick}>Hapus</Dropdown.Item>
...
export default Contenttabelprodukdatarannonaktif;
