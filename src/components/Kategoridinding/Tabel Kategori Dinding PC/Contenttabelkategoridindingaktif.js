...
function Contenttabelkategoridindingaktif() {
  ...
  const handleDeleteClick = (kategori) => {
   ...
   const handleArchiveClick = (kategori) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        Swal.fire("Berhasil!", "Kategori berhasil diarsipkan.", "success");
        // Di sini Anda dapat menambahkan logika untuk mengarsipkan kategori
        // Contoh: dispatch action ke Redux untuk mengarsipkan kategori
      }
    });
  };
...
export default Contenttabelkategoridindingaktif